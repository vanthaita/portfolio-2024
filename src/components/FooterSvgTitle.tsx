...
export const FooterTitle = () => {
  return (
    <svg width="1382.4" height="179.2" viewBox="0 0 1382.4 179.2" xmlns="http://www.w3.org/2000/svg">
        <g id="svgGroup" strokeLinecap="round" fillRule="nonzero" fontSize="9pt" stroke="#000" strokeWidth="0.25mm" fill="#555555">
